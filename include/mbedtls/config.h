...
#include <stdio.h>
#define MBEDTLS_PLATFORM_SNPRINTF_MACRO _snprintf

#define MBEDTLS_PLATFORM_C
#define MBEDTLS_PLATFORM_MEMORY

#include <stdio.h>  // Required for _vsnprintf definition
#define MBEDTLS_PLATFORM_VSNPRINTF_MACRO _vsnprintf

#define MBEDTLS_MPI_WINDOW_SIZE 1  // Reduces RSA stack usage
#define MBEDTLS_MPI_MAX_SIZE 256   // Max 2048-bit keys (256 bytes)
#define MBEDTLS_SSL_MAX_CONTENT_LEN 4096 // Reduce TLS record size
